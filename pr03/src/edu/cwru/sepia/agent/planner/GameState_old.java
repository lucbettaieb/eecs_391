 ...
 */
public class GameState_old implements Comparable<GameState_old> {
     ...
     */
    public GameState_old(State.StateView state, int playernum, int requiredGold, int requiredWood, boolean buildPeasants){
        this.state = state;
     ...
     * myConstructor
     */
    public GameState_old(GameState_old parent, double costToMe){
     ...
     */
    public List<GameState_old> generateChildren() {
        // TODO: Implement me!
        return null;
    }
     ...
     */
    @Override
    public int compareTo(GameState_old o) {
